...
const I18N = {
  en: {
    ...
    googleSSONotRegistered: "This Google account is not registered. Contact your admin.",
    googleSSONotReady: "Google Sign-In is not ready yet. Try again in a moment.",
  ...
  he: {
    ...
    googleSSONotRegistered: "חשבון Google זה אינו רשום במערכת. פנה למנהל.",
    googleSSONotReady: "כניסת Google עדיין אינה מוכנה. נסה שוב בעוד רגע.",
